...
flowchart TD
    subgraph Docker["Docker Environment"]
        subgraph API["R Plumber API<br/>(Port 8000)"]
            PatientData["Patient Data<br/>Demographics<br/>Insurance Info"]
        end
        
        subgraph DB["PostgreSQL DB<br/>(Port 5432)"]
            Visits["Visits<br/>Prescriptions<br/>Lab Results"]
        end
    end
    
    subgraph Clients["Client Pipelines"]
        RClient["R Client<br/>Pipeline"]
        PythonClient["Python Client<br/>Pipeline"]
    end
    ...
    RClient --> Combined["Combined Data<br/>(Patient + Visit Summary)"]
    PythonClient --> Combined
